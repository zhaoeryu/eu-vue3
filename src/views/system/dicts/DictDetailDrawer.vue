  ...
  >
    <query-expand-wrapper :show="state.isQueryShow">
      ...
      >
        ...
        >
          <el-input
            v-model="state.queryParams.dictKey"
            placeholder="输入要查找的字典KEY"
            maxlength="30"
          />
        </el-form-item>
        <el-form-item>
    ...
    <div v-loading="loading">
      ...
      >
        ...
        ></el-table-column>
        <el-table-column
          v-permissions="['system:dict-detail:edit', 'system:dict-detail:del']"
          label="操作"
          width="200"
        >
          <template #default="{ row }">
            <el-button
              v-permissions="['system:dict-detail:edit']"
              text
              type="primary"
              @click="onRowUpdate(row)"
            >修改</el-button>
            <el-button
              v-permissions="['system:dict-detail:del']"
              text
              type="primary"
    ...
    <dict-detail-edit-dialog
      ref="refDictDetailEditDialog"
      @complete="onRefresh"
    />
    <import-dialog
      ref="refImportDialog"
