    ...
    <div class="page-body">
      ...
      <div v-loading="loading">
        ...
        >
          ...
          <el-table-column
            v-permissions="['system:dict-detail:list', 'system:dict:edit', 'system:dict:del']"
            label="操作"
            width="200"
          >
            <template #default="{ row }">
              <el-button
                v-permissions="['system:dict-detail:list']"
                text
                type="primary"
                @click="onRowDetail(row)"
              >详情 </el-button>
              <el-button
                v-permissions="['system:dict:edit']"
                text
                type="primary"
                @click="onRowUpdate(row)"
              >修改</el-button>
              <el-button
                v-permissions="['system:dict:del']"
                text
                type="primary"
