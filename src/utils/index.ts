 ...
 */
export function flattenTreeData(data: TreeNode[], options: {
  childrenKey?: string
} = {} as {
  childrenKey?: string
}): TreeNode[] {
 ...
 * @returns {Array} 字段值数组
 */
export function getChildrenFields(node: TreeNode, options: {
  fieldKey: string
  childrenKey?: string
} = {} as {
  fieldKey: string
 ...
 * @returns {*} 字段值
 */
export function getFirstChildrenFields(node: TreeNode, options: {
  fieldKey: string
  childrenKey?: string
 ...
 * @returns {Array} 父节点路径
 */
export function getParentFieldsByLeafId(tree: TreeNode[], leafId: string | number | null, options: {
  fieldKey: string
  idKey?: string
  childrenKey?: string
} = {} as {
